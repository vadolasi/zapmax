...
const VirtualizedCommand = ({
  ...
  React.useEffect(() => {
    if (selectedOption) {
      const option = filteredOptions.find((option: { value: string; }) => option.value === selectedOption);
      if (option) {
    ...
    <Command shouldFilter={false} onKeyDown={handleKeyDown}>
      ...
      >
        ...
        <CommandGroup>
          ...
          >
            {virtualOptions.map((virtualOption: { index: string | number; size: any; start: any; }) => (
              <CommandItem
